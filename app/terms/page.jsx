...
export default function TermsPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 py-16 md:py-24 px-6 font-sans selection:bg-blue-500/30">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content Container */}
        <div className="bg-white border border-slate-200 rounded-[2rem] shadow-xl p-8 md:p-12 lg:p-16">
          ...
          <div className="space-y-10 text-slate-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">2. Course Enrollment Policy</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">3. Fees & Payment Policy</h2>
              <ul className="list-disc pl-5 space-y-2 marker:text-blue-500">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Online Classes Policy</h2>
              <ul className="list-disc pl-5 space-y-2 marker:text-blue-500">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Attendance & Participation</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Certificates Policy</h2>
              <ul className="list-disc pl-5 space-y-2 marker:text-blue-500">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">7. Refund & Cancellation Policy</h2>
            ...
            {/* 8. Student Conduct */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">8. Student Conduct</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">10. Privacy & Data Usage</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">11. Modification of Terms</h2>
              <p>
            ...
            <section className="pt-8 border-t border-slate-200">
              ...
              <div className="grid sm:grid-cols-3 gap-6">
                <div className="flex flex-col p-6 rounded-2xl bg-slate-50 border border-slate-200">
                  ...
                  <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider mb-1">Call Us</span>
                  <a href="tel:+919354486861" className="font-bold text-slate-900 hover:text-blue-600 transition-colors">+91 93544 86861</a>
                </div>
                
                <div className="flex flex-col p-6 rounded-2xl bg-slate-50 border border-slate-200">
                  <Mail className="text-blue-500 mb-3" size={24} />
                  <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider mb-1">Email Us</span>
                  <a href="mailto:contact@vivexatech.in" className="font-bold text-slate-900 hover:text-blue-600 transition-colors">contact@vivexatech.in</a>
                </div>

                <div className="flex flex-col p-6 rounded-2xl bg-slate-50 border border-slate-200">
                  <Globe className="text-blue-500 mb-3" size={24} />
                  <span className="text-sm text-slate-500 font-semibold uppercase tracking-wider mb-1">Website</span>
                  <a href="https://vit.vivexatech.in" target="_blank" rel="noopener noreferrer" className="font-bold text-slate-900 hover:text-blue-600 transition-colors">vit.vivexatech.in</a>
                </div>
              </div>
            </section>
