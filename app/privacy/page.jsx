  ...
  return (
    <main className="min-h-screen bg-slate-50 py-16 md:py-24 px-6 font-sans selection:bg-blue-500/30">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Content Container */}
        <div className="bg-white border border-slate-200 rounded-[2rem] shadow-xl p-8 md:p-12 lg:p-16 relative overflow-hidden">
          
          {/* Subtle Background Accent */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-blue-500/5 rounded-full blur-[80px] pointer-events-none"></div>

          <div className="space-y-10 text-slate-700 leading-relaxed relative z-10">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Online Classes & Communication</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">8. Information Sharing Policy</h2>
            ...
            {/* 9. Student Rights */}
            <section>
              <h2 className="text-2xl font-bold text-slate-900 mb-4">9. Student Rights</h2>
              <p>
